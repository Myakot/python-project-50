def create_diff(data_1: dict, data_2: dict) -> list:
    ...
    Returns:
    - diff (list): A list of differences between the two dictionaries.
    Each difference is represented as a dictionary with the following keys:
        ...
        - type (str): The type of difference. Possible values are:
            ...
            - 'nested': The key is present in both dictionaries and its value
            is a nested dictionary. The nested dictionary represents the
            differences in the values of the key.
            - 'unchanged': The key is present in both dictionaries and its
            value is the same in both.
            - 'changed': The key is present in both dictionaries and its value
            is different in data_1 and data_2. The value is a tuple containing
            the old value from data_1 and the new value from data_2.
