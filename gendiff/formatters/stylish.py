...
def stringify(data, replacer=' ', spaces_count=4, indent_size=0):
    """Convert any primitive value or standard collection to a special format string
    Args:
        data: Any primitive value or standard collection
...
def generate_stylish_diff(dicts_diff: dict) -> str:
    """Returns a special formatted json-like text representation of the given
      dicts diff file.
    Args:
        dicts_diff: A special format dictionary that describes the difference
